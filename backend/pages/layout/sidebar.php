...
<div id="sidebar-menu" class="sidebar-menu">
	<ul>
		...
		<li class="<?php active('index.php?product=product');?>">
			<a href="index.php?product=product"><i class="fa fa-cube"></i> <span>Product</span></a>
		</li>
		<li class="<?php active('index.php?appointment=appointments');?>">
			<a href="index.php?appointment=appointments"><i class="fa fa-calendar"></i> <span>Order</span></a>
		</li>
		<li>
			<a href="schedule.html"><i class="fa fa-calendar-check-o"></i> <span>Customer Schedule</span></a>
		</li>
		<li>
